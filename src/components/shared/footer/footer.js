...
const FooterComp = () => {
  return (
    <footer className="mt-auto w-full py-10 px-4 sm:px-6 lg:px-8">
      {/* Grid */}
      <div className="text-center">
        ...
        {/* End Col */}
        <div className="mt-3">
          <p className="text-gray-500">Learning is a never-ending process. </p>
          <p className="text-gray-500">© HY-05 2023. All rights reserved.</p>
        </div>
        {/* Social Brands */}
